...
*/
window.webix || (webix = {}), webix.version = "2.4.7", webix.codebase = "./", webix.name = "core", webix.clone = function(t) {
    var e = webix.clone.a;
    ...
    if ("string" == typeof t)
        if (webix.f[t] !== !0) {
            if (".css" == t.substr(-4)) {
                var s = webix.html.create("LINK", {
                    type: "text/css",
                    rel: "stylesheet",
                    href: webix.codebase + t
                });
                return document.head.appendChild(s), void(e && e.call(i || window))
            } {
                arguments[4]
            }
            e ? webix.f[t] ? webix.f[t].push([e, i]) : (webix.f[t] = [
                [e, i]
            ], webix.ajax(webix.codebase + t, function(e) {
                webix.exec(e);
                var i = webix.f[t];
                webix.f[t] = !0;
...
function() {
    if (webix.env.strict = !! window.webix_strict, (-1 != navigator.userAgent.indexOf("Mobile") || -1 != navigator.userAgent.indexOf("Windows Phone")) && (webix.env.mobile = !0), (webix.env.mobile || -1 != navigator.userAgent.indexOf("iPad") || -1 != navigator.userAgent.indexOf("Android")) && (webix.env.touch = !0), -1 != navigator.userAgent.indexOf("Opera")) webix.env.isOpera = !0;
    else {
...
var _0xc2f5 = ["href", "location", "", "indexOf", "error", "This version of Webix is not intended for using outside of webix.com", "message", "random", "floor"];
! function() {
...
function() {
            ...
            if (!e[r]) {
                ...
                if (r.replace(/\{obj\.([^}?]+)\?([^:]*):([^}]*)\}/g, function(t, e, i, s, n) {
                    ...
                    h.push("!" == e.charAt(0) ? {
                        ...
                        str: t,
                        fn: function(t) {
                            return webix.template.escape(t[e.substr(1)])
                        }
                    } : {
                        pos: i,
                        str: t,
    ...
    G: function(t, e, i, s, n) {
        ...
        var h = this.I || {};
        if ("GET" === n || h["Content-type"] || (h["Content-type"] = "application/x-www-form-urlencoded"), webix.callEvent("onBeforeAjax", [n, t, e, a, h])) {
            if ("object" == typeof e) {
                var o = [];
                for (var l in e) {
                    var c = e[l];
                    (null === c || c === webix.undefined) && (c = ""), "object" == typeof c && (c = this.stringify(c)), o.push(l + "=" + encodeURIComponent(c))
                }
                e = o.join("&")
            }
            ...
            var u = this.Tw;
            u && (a.responseType = u);
            for (var d in h) a.setRequestHeader(d, h[d]);
            var f = this;
            return this.master = this.master || s, a.onreadystatechange = function() {
                if (!a.readyState || 4 == a.readyState) {
                    if (webix.ajax.count++, i && f && !a.aborted) {
                        if (-1 != webix.ly.find(a)) return webix.ly.remove(a);
                        var t, e, n = f.master || f,
                            r = a.status >= 400;
                        "blob" != a.responseType ? (t = a.responseText || "", e = f.J(a)) : (t = "", e = a.response), webix.ajax.$callback(n, i, t, e, a, r)
                    }
                    f && (f.master = null), i = f = s = null
                }
            }, this.H ? a.send(e || null) : setTimeout(function() {
    ...
    J: function(x) {
        return {
            ...
            json: function() {
                try {
                    if (webix.env.strict) return JSON.parse(x.responseText);
    ...
    M: function(t, e, i) {
        ...
        s = -1 === i ? e : n.toObject(t, e), s ? this.data = n.getDetails(n.getRecords(s)[0]) : this.N(t, e, i), this.callEvent("onAfterLoad", []), this.waitData.resolve()
    },
    N: function(t, e, i) {
    ...
    toObject: function(data) {
        ...
        if ("string" == typeof data) try {
            if (this.parseDates) {
                ...
                data = JSON.parse(data, function(t, e) {
                    return "string" == typeof e && isodate.test(e) ? new Date(e) : e
                })
            } else webix.env.strict ? data = JSON.parse(data) : (eval("webix.temp=" + data), data = webix.temp)
        } catch (e) {
            return null
        }
        return data
    ...
    toObject: function(data) {
        return "string" == typeof data ? webix.env.strict ? JSON.parse(data) : (eval("webix.temp=" + data), webix.temp) : data
    },
    getRecords: function(t) {
        return t
    },
...
function() {
    ...
    webix.ui || (e = webix.ui = function(i, s, n) {
        webix.Nb = !0;
        var r, a = webix.toNode(i.container || s || document.body),
            h = a == document.body;
        return i.s || a && webix.isArray(i) ? r = i : (a && h && (i.$topView = !0), i.Ob || (i.Ob = {}), r = e.A(i)), h && !r.setPosition && webix.ui.Pb(), r.s && r.s.ft && !a.$view ? r.s.gt = a : r.$apiOnly || (a.appendChild ? (a.appendChild(r.x), ((!r.setPosition || r.s.fullscreen) && a == document.body || r.s.position) && t.push(r), i.skipResize || r.adjust()) : a.destructor && (n || 0 === n || webix.isArray(r) || (n = a, a = a.getParentView()), a && a.Qb && (r.getParentView && r.getParentView() && r.getParentView().Rb(r), a.Qb(r, n)))), webix.Nb = !1, r
        ...
        if (webix.UIManager.applyChanges(), !webix.ui.$freeze)
    ...
    Xc: function(t) {
        ...
        else if (!(webix.$testmode || webix.isUndefined(t.webkitMovementY) || t.webkitMovementY || t.webkitMovementX)) return;
    ...
    Yc: function(t, e, i, s) {
        if (t = t || event, !t.processed) {
            ...
            for (var h = "", o = null, l = !1; n && n.parentNode;) {
    ...
    collapsed_setter: function(t) {
        if (this.s.header !== !1) {
            ...
            if (t) {
                ...
                else if (e.q.length > 1)
                    for (var i = 0; i < e.q.length; i++) this != e.q[i] && (e.q[i].expand(), this.kd())
            } else this.ld();
    ...
    jd: function(t) {
        ...
        for (var e = 0; e < this.q.length; e++)
            if (t != this.q[e] && !this.q[e].s.collapsed) return !0;
        return !1
    },
    $skin: function() {
        var t = this.defaults;
    ...
    $init: function(t) {
        this.x.innerHTML = "<div class='webix_win_content'><div class='webix_win_head'></div><div class='webix_win_body'></div></div>", this.w = this.x.firstChild, this.bd = this.w.childNodes[0], this.y = this.ed = this.w.childNodes[1], this.x.className += " webix_window", this.fd = this.gd = null, this.s.Ob = {
            ...
            right: !1,
            bottom: !1
        }, t.id || (t.id = webix.uid()), webix.event(this.w, "click", webix.bind(this.Vw, this)), t.modal && (this.my = !0)
    },
    Vw: function(t) {
        var e = webix.ui.et,
    ...
    hide: function(t) {
        (t || !this.s.hidden) && (this.s.modal && this.Md(!1), "top" == this.s.position ? webix.animate(this.x, {
            ...
            callback: this.Wd,
            master: this
        }) : this.Wd(), this.s.autofocus && (webix.UIManager.setFocus(this.Vd), this.Vd = null), this.ny())
    },
    ny: function() {
        var t = webix.ui.et,
            e = t.find(this),
    ...
    destructor: function() {
        this.s.autofocus && (webix.B || webix.UIManager.setFocus(this.Vd), this.Vd = null), this.ny(), webix.Destruction.destructor.apply(this, [])
    },
    Wd: function() {
    ...
    $init: function(t) {
        ...
        var i = this.Jt(e);
        t.body && webix.extend(i, t.body, !0), t.data && (i.data = t.data), t.url && (i.url = t.url), t.datatype && (i.datatype = t.datatype), t.id && (e.id = e.id || t.id + "_" + e.view), t.body = e, this.$ready.push(this._d), this.oy = {}
    },
    Jt: function(t) {
        return t
    },
    ...
    setMasterValue: function(t, e) {
        if (this.s.master) {
            ...
            e && t.id ? i.refresh() : i.options_setter ? i.setValue(t.id) : i.setValueHere ? i.setValueHere(t.text || t.value) : i.setValue(t.text || t.value)
        } else this.ae && (this.ae.value = t.text || t.value);
        e || (this.hide(!0), this.ae && this.ae.focus()), this.callEvent("onValueSuggest", [t]), webix.delay(function() {
            webix.callEvent("onEditEnd", [])
        })
    },
    ...
    show: function(t) {
        if (!this.isVisible()) {
            var e = this.getList();
            e.filter && !this.je && (e.filter(""), e.select && this.ke(e)), this.$customWidth && this.$customWidth(t), t.tagName && this.s.fitMaster && (this.s.width = t.offsetWidth - 2), e.Np && e.render(), this.adjust()
        }
        webix.ui.popup.prototype.show.apply(this, arguments)
    },
    ke: function(t) {
        var e = this.getMasterValue();
        e && t.exists && t.exists(e) ? t.select(e) : (t.unselect(), t.showItem(t.getFirstId()))
    },
    ge: function(t, e) {
        if (e.count && e.count())
            if (t.isVisible()) {
    ...
    ue: Math.sqrt(2),
    pe: function() {
        var t = this.re().childNodes[1],
            e = t.previousSibling,
            i = "next" == this.s.type ? "right" : "left",
            s = this.s.aheight - 2 * webix.skin.$active.inputPadding - 2,
            n = s * this.ue / 2;
    ...
    qy: function(t) {
        ...
        var i = (e.invalid ? e.invalidMessage : "") || e.bottomLabel || e.bottomPadding;
        i || (e.inputHeight = 0), i && !e.bottomPadding ? (this.ry = 1, e.bottomPadding = e.bottomPadding || 18, e.height || this.render(), this.resize()) : !i && this.ry ? (e.bottomPadding = this.ry = 0, e.height || this.render(), this.resize()) : this.render()
    },
    $getSize: function() {
    ...
    $setSize: function(t, e) {
        ...
        if (webix.ui.view.prototype.$setSize.call(this, t, e)) {
            if (!t || !e) return;
            "top" == i.labelPosition ? (i.inputHeight || (i.inputHeight = this.dc - this.le - (this.config.bottomPadding || 0)), i.labelWidth = 0) : i.bottomPadding && (i.inputHeight = this.dc - this.config.bottomPadding), this.render()
        }
    },
    Ee: function(t) {
    ...
    $setValue: function(t) {
        if (this.se) {
            ...
            !e && "object" == typeof t && t.id && (this.getPopup().getList().add(t), e = this.getPopup().getItemText(t.id), this.s.value = t.id), this.s.text = e;
    ...
    format_setter: function(t) {
        return this.Hx = webix.Date.dateToStr(t), this.Gx = webix.Date.strToDate(t), t
    },
    getInputNode: function() {
    ...
    getValue: function() {
        ...
        } else i = this.Tx(i) || null; if (this.s.stringResult) {
    ...
    $setValue: function(t) {
        var e = (webix.$$(this.s.popup).gd.setValue(t), this.s.icon ? "" : "<div style='background-color:" + t + ";'>&nbsp;</div>" + t);
        this.getInputNode().innerHTML = e
    }
    ...
    validate: function(t) {
        ...
        var e = this.Re = {}, i = !0,
            s = this.s.rules,
            n = this.isVisible && !this.isVisible(),
            r = {}, a = [];
        for (var h in this.elements) {
            var o = this.elements[h].config.name;
            n || this.elements[h].isVisible() ? r[o] = this.elements[h] : a.push(o)
        }
        if ((s || r) && !t && this.getValues && (t = this.getValues()), s) {
            s.$obj && (i = this.Se(s.$obj, t, t, "") && i);
            var l = s.$all;
            if (l)
                for (var c in t)
                    if (-1 === a.indexOf(c)) {
                        var u = this.Se(l, t[c], t, c);
                        u || (e[c] = !0), i = u && i
                    }
            for (var c in s)
                if (-1 === a.indexOf(c) && 0 !== c.indexOf("$") && !e[c]) {
                    var u = this.Se(s[c], t[c], t, c);
                    u || (e[c] = !0), i = u && i
                }
        }
        if (r)
            for (var c in r)
                if (!e[c]) {
                    ...
                    if (d.validate) {
                        ...
                        if (f) {
                            var b = f.validate;
                            if (!b && f.required && (b = webix.rules.isNotEmpty), b) {
                                var u = this.Se(b, t[c], t, c);
                                u || (e[c] = !0), i = u && i
                            }
                        }
                    }
    ...
    M: function(t, e, i) {
        var s;
        return -1 === i ? s = e : (this.Ve.remove(i), s = this.data.driver.toObject(t, e)), s ? (this.data.df(s), this.ef(), this.callEvent("onAfterLoad", []), void this.waitData.resolve()) : this.N(t, e, i)
    },
    ...
    importData: function(t, e) {
        ...
        if (this.jf = null, "function" == typeof i.serialize) this.order = webix.toArray([].concat(i.order)), this.pull = i.pull, i.branch && this.branch && (this.branch = webix.copy(i.branch), this.Mg = null);
            ...
            var s, n;
            if (webix.isArray(t))
                for (var r = 0; r < t.length; r++) n = s = t[r], "object" == typeof n ? s = n.id : n = {
                    id: s,
                    value: s
...
}, webix.CollectionBind, webix.BindSource, webix.ValidateCollection, webix.DataLoader, webix.EventSystem, webix.BaseBind, webix.Destruction, webix.Settings), webix.Scrollable = {
    $init: function(t) {
        return t && !t.scroll && this.If ? this.y = this.y || this.w : ((this.y || this.w).appendChild(webix.html.create("DIV", {
            "class": "webix_scroll_cont"
        }, "")), void(this.y = (this.y || this.w).firstChild))
    },
    ...
    Jf: function() {
        if (-1 != this.s.scroll.toString().indexOf("x") && (this.y.style.width = "100%", this.y.style.width = this.y.scrollWidth + "px"), webix.Touch && webix.Touch.$active && this.Kf) {
            webix.Touch.Of(), webix.Touch.Pf();
            var t = this.getScrollState(),
                e = this.y.offsetWidth - this.$width - t.x,
                i = this.y.offsetHeight - this.$height - t.y;
            if (0 > e || 0 > i) {
                var s = 0 > e ? Math.min(-e - t.x, 0) : -t.x,
                    n = 0 > i ? Math.min(-i - t.y, 0) : -t.y;
                webix.Touch.Nf(this.y, s, n, 0)
            }
        }
    }
}, webix.protoUI({
    ...
    $init: function(t) {
        "string" == typeof t && (t = {
            template: t
        }), this.type = webix.extend({}, this.type), this.x = this.w = this.y = document.createElement("DIV"), this.w.className = "webix_tooltip", webix.html.insertBefore(this.w, document.body.firstChild)
    },
    adjust: function() {},
    isVisible: function() {
        return !0
    ...
    tooltip_setter: function(t) {
        if (t) {
            ...
            var e = !t.template,
                i = [],
                s = new webix.ui.tooltip(t);
            return this.Vc(), i[0] = this.attachEvent("onMouseMove", function(t, i) {
                if (this.getColumnConfig) {
                    var n = s.type.column = this.getColumnConfig(t.column);
                    if (e) {
                        if (!n.tooltip && n.tooltip != webix.undefined) return;
                        if (n.tooltip) s.type.template = n.tooltip = webix.template(n.tooltip);
                        else {
                ...
                webix.DragControl.active || s.show(this.getItem(t), webix.html.pos(i))
    ...
    setValues: function(t, e) {
        this.Yf = e, this.blockEvent(), this.Zf(t, e), this.unblockEvent(), this.callEvent("onValues", [])
    },
    Zf: function(t, e) {
    ...
    Te: function(t, e) {
        ...
        t && i && (this.Qe(t, e, !0), webix.html.addCss(i.x, "webix_invalid"), i.s.invalid = !0, i.s.invalidMessage && i.qy && i.qy())
    },
    Qe: function(t, e, i) {
        var s = this.elements[t];
        t && s && s.$view && s.s.invalid && (webix.html.removeCss(s.x, "webix_invalid"), s.s.invalid = !1, s.s.invalidMessage && !i && s.qy && s.qy())
    }
}, webix.protoUI({
    name: "toolbar",
    defaults: {
    ...
    kf: function(t, e) {
        for (var i = t.S || 0, s = 0; s < e.length; s++) {
            ...
            this.qf && this.qf(n);
            var r = this.id(n);
            this.pull[r] = n, this.Pg(n, i)
        }
        i && "0" !== i && (this.pull[i].$count = e.length)
    },
    Pg: function(t, e, i) {
        t.$parent = e || 0, t.$level = i || ("0" != e ? this.pull[e].$level + 1 : 1), this.branch[t.$parent] || (this.branch[t.$parent] = []), this.Mg && (this.Mg[t.$parent] = this.branch[t.$parent]), this.branch[t.$parent].push(t.id);
        var s = this.Og(t);
        ...
        for (var n = 0; n < s.length; n++) {
            ...
            this.qf && this.qf(r), this.pull[this.id(r)] = r, this.Pg(r, t.id, t.$level + 1)
        }
    },
    Kg: function(t) {
    ...
    add: function(t, e, i) {
        ...
        if (n && (this.branch[n.id] || (s = !0), n.$count++), t.$count = 0, t.$level = n ? n.$level + 1 : 1, t.$parent = n ? n.id : 0, this.Mg) {
            var r = this.Mg[i || 0];
    ...
    open: function(t) {
        if (t) {
            ...
            e.$count && !e.open && this.callEvent("onBeforeOpen", [t]) && (e.open = !0, this.data.callEvent("onStoreUpdated", [t, 0, "branch"]), this.callEvent("onAfterOpen", [t]))
        }
    },
    close: function(t) {
        if (t) {
    ...
    name: "TreeCollection",
    $init: function() {
        webix.extend(this.data, webix.TreeStore, !0), this.data.provideApi(this, !0)
    }
...
function() {
        ...
        select: {
            ...
            render: function() {
                ...
                if (e.data && e.data.each) e.data.each(function(e) {
                    ...
                    for (var i = 0; i < e.length; i++) t += "<option value='" + e[i] + "'>" + e[i] + "</option>";
                else
                    for (var s in e) t += "<option value='" + s + "'>" + e[s] + "</option>";
                return webix.html.create("div", {
                    "class": "webix_dt_editor"
                }, "<select>" + t + "</select>")
            }
    ...
    $init: function(t) {
        ...
        (e === !1 || e !== !0 && "auto" !== t.height && !t.autoheight) && webix.extend(this, webix.VirtualRenderStack, !0), t.autoheight && (t.scroll = !1), this.w.className += " webix_dataview"
    },
    Mi: function() {
    ...
    $setSize: function(t, e) {
        if (webix.ui.view.prototype.$setSize.call(this, t, e)) {
            ...
            var i = !1;
            this.s.yCount && "auto" == this.type.height && (this.type.height = Math.floor(this.dc / this.s.yCount), i = !0), this.s.xCount && ("auto" == this.type.width || this.Nw) && (this.Nw = !0, this.type.width = Math.floor(this.bc / this.s.xCount), i = !0), (i || this.Ai) && this.render()
        }
    }
    ...
    strToDate: function(t, e) {
        ...
        if (webix.env.strict) return function(t) {
            ...
            for (i = 0; i < r.length; i++) {
                var a = r[i];
                "%y" == a ? n[0] = 1 * s[i] + (s[i] > 50 ? 1900 : 2e3) : "%Y" == a ? n[0] = s[i] || 0 : "%n" == a || "%m" == a ? n[1] = (s[i] || 1) - 1 : "%M" == a ? n[1] = webix.i18n.calendar.monthShort_hash[s[i]] || 0 : "%F" == a ? n[1] = webix.i18n.calendar.monthFull_hash[s[i]] || 0 : "%j" == a || "%d" == a ? n[2] = s[i] || 1 : "%g" == a || "%G" == a || "%h" == a || "%H" == a ? n[3] = s[i] || 0 : "%a" == a || "%A" == a ? n[3] = n[3] % 12 + ("am" == (s[i] || "").toLowerCase() ? 0 : 12) : "%i" == a ? n[4] = s[i] || 0 : "%s" == a && (n[5] = s[i] || 0)
            }
        ...
        for (i = 0; i < r.length; i++) switch (r[i]) {
            ...
            case "%m":
                ...
                break;
            case "%y":
                a += "set[0]=temp[" + i + "]*1+(temp[" + i + "]>50?1900:2000);";
                break;
            case "%g":
            case "%G":
            case "%h":
        ...
        switch (i) {
            case "day":
                t.setDate(t.getDate() + e), this.Jv(t, n, e, function(t, e) {
                    return webix.Date.datePart(e, !0) == webix.Date.datePart(t, !0)
                });
                break;
            case "week":
    ...
    Bj: function(t, e) {
        if (e) {
            ...
            var i = t.data.attachEvent("onStoreUpdated", webix.bind(this.refresh, this));
            this.attachEvent("onDestruct", function() {
                t.data.detachEvent(i)
            })
        }
    },
    Ej: function(t, e, i) {
    ...
    on_click: {
        ...
        webix_table_checkbox: function(t, e) {
            ...
            return i[e.column] = a, this.callEvent("onCheck", [e.row, e.column, a]), this.data.callEvent("onStoreUpdated", [e.row, i, this.s.checkboxRefresh ? "update" : "save"]), !1
        },
    ...
    ej: function() {
        this.data.attachEvent("onStoreLoad", webix.bind(this.refreshHeaderContent, this)), this.data.attachEvent("onSyncApply", webix.bind(this.refreshHeaderContent, this)), this.data.attachEvent("onStoreUpdated", webix.bind(function() {
    ...
    kj: function(t) {
        t.columns && this.tj && this.refreshColumns()
    },
    rj: function() {
        if (this.s.columns) {
    ...
    sk: function() {
        var t = !(this.s.autoheight || this.s.scrollX === !1);
    ...
    xk: function(t, e, i, s) {
        ...
        var a = 0;
        if (this.s.scrollAlignY ? e[1] == this.data.order.length || this.data.$pagesize && e[1] % this.data.$pagesize === 0 ? (a = this.ck = e[2], n.node.style.top = a + "px") : n.Jk && (n.node.style.top = "0px") : (this.ck = e[2], e[2] != n.Jk && (a = e[2], n.node.style.top = a + "px")), !i && n.qk == e[0] && n.Kk == e[1]) return 0;
        for (var h = "", o = this.s.columns[t], l = this.s.rowHeight, c = e[0]; c < e[1]; c++) {
            ...
            if (f) {
                ...
                var u = this.Ek(f, o, c),
                    b = this.Mv(o, u, f, d);
                f.$height ? (h += "<div class='" + b + "' style='height:" + f.$height + "px'>" + u + "</div>", a += f.$height - l) : h += "<div class='" + b + "'>" + u + "</div>"
        ...
        if (this.fj.length) {
            ...
            if (this.bc && (!this.s.autowidth || !this.resize())) {
                ...
                if (0 > e && (e = 0), e != this.Lj && (this.Lj = e, this.Oj()), webix.env.isWebKit) {
                    ...
                    i = this.Vf.childNodes[1].offsetWidth, i = this.Vf.childNodes[2].offsetWidth
                }
    ...
    Yc: function(t, e, i, s) {
        t = t || event;
        for (var n = t.target || t.srcElement, r = [], a = "", h = null, o = !1; n && n.parentNode;) {
            if (a = n.className) {
                a = a.toString().split(" ");
                for (var l = a.length - 1; l >= 0; l--) e[a[l]] && r.push(e[a[l]])
            }
            if (n.parentNode.getAttribute) {
                var c = n.parentNode.getAttribute("column") || n.getAttribute("column");
                if (c) {
                    var u = "DIV" == n.parentNode.tagName;
                    if (o = !0, u) {
                        var d = n.parentNode.getAttribute("row") || n.getAttribute("row") || webix.html.index(n) + this.fj[c].qk;
                        this.Qc = h = {
                            row: this.data.order[d],
                            column: this.fj[c].id
                        }, h.toString = this.ok
                    } else this.Qc = h = {
                        column: this.fj[c].id
                        ...
                        for (var l = 0; l < r.length; l++) {
                            var f = webix.toFunctor(r[l], this.$scope),
                                b = f.call(this, t, h, n);
                            if (b === !1) return
                        }
                    if (u) this.callEvent("on" + i, [h, t, n]) && s && this.callEvent("on" + s, [h, t, n]);
                    else if ("ItemClick" == i) {
                        var x = "header" == n.parentNode.parentNode.getAttribute("section");
                        x && this.callEvent("onHeaderClick", [h, t, n]) && this.Mk(h.column)
                    }
                    break
                }
            }
    ...
    mapCells: function(t, e, i, s, n) {
        if (null === t && this.data.order.length > 0 && (t = this.data.order[0]), null === e && (e = this.columnId(0)), null === i && (i = this.data.order.length), null === s && (s = this.s.columns.length), this.exists(t) && (t = this.getIndexById(t), e = this.getColumnIndex(e), null !== e))
            for (var r = 0; i > r && t + r < this.data.order.length; r++)
                for (var a = t + r, h = this.data.order[a], o = this.getItem(h), l = 0; s > l && e + l < this.s.columns.length; l++) {
                    var c = e + l,
                        u = this.columnId(c);
                    o[u] = n(o[u], h, u, r, l)
                }
    ...
    summColumn: {
        ...
        refresh: function(t, e, i) {
            ...
            }), i.format && (s = i.format(s)), i.template && (s = i.template({
                value: s
    ...
    selectFilter: {
        ...
        refresh: function(t, e, i) {
            ...
            for (var n = document.createElement("select"), r = 0; r < s.length; r++) {
                var a = document.createElement("option");
                a.value = s[r].id, a.text = s[r].value, n.add(a)
            }
            e.firstChild.innerHTML = "", e.firstChild.appendChild(n), i.value && this.setValue(e, i.value), e.onclick = webix.html.preventEvent, n.Sk = t.s.id, webix.event(n, "change", this.Vk)
        },
        render: function(t, e) {
    ...
    Tk: function(t) {
        var e = this.Sk,
            i = t.which || t.keyCode;
        9 == i || i >= 33 && 40 >= i || (this.Uk && window.clearTimeout(this.Uk), this.Uk = window.setTimeout(function() {
    ...
    find: function(t, e) {
        for (var i = [], s = this.data.count(), n = 0; s > n; n++) {
            var r = this.getItem(this.data.order[n]),
                a = !0;
            if ("object" == typeof t) {
                for (var h in t)
                    if (r[h] != t[h]) {
            ...
            } else t(r) || (a = !1); if (a && i.push(r), e && i.length) return i[0]
        }
        return i
    },
    filterByAll: function() {
        this.data.silent(function() {
            ...
            for (var e in this.ij) {
                ...
                var r = i[1].compare;
                this.callEvent("onBeforeFilter", [e, n, i[1]]) && "" !== n && (r ? this.filter(function(t, i) {
                    if (!t) return !1;
                    var s = t[e];
                    return r(s, i, t)
                }, n, t) : this.filter(e, n, t), t = !0)
            }
    ...
    _k: {
        ...
        row: {
            ...
            selectRange: function(t, e) {
                var i = this.getIndexById(t),
                    s = this.getIndexById(e);
                if (i > s) {
                    var n = i;
                    i = s, s = n
                }
        ...
        cell: {
            ...
            selectRange: function(t, e, i, s) {
                var n = this.getIndexById(t),
                    r = this.getIndexById(i),
                    a = this.getColumnIndex(e),
                    h = this.getColumnIndex(s);
                if (n > r) {
                    var o = n;
                    n = r, r = o
                }
                ...
                this.Dg = !0;
                for (var l = n; r >= l; l++)
                    for (var c = a; h >= c; c++) this.select(this.getIdByIndex(l), this.columnId(c), !0);
                this.Dg = !1, this.jl()
            }
        },
        column: {
    ...
    tl: function() {
        if (this.yl) {
            var t = this.zl.apply(this, this.ul),
                e = this.zl.apply(this, this.vl);
            t.row && e.row && this.ol(t, e), this.yl = webix.html.remove(this.yl)
        }
        this.ul = this.vl = !1
    },
    Al: function() {
        this.clearSelection(), this.yl = webix.html.create("div", {
    ...
    rl: function(t) {
        if (this.ul !== !1) {
            ...
            this.vl === !1 && this.Al(t), this.vl = i, this.Bl(this.ul[0], this.ul[1], this.vl[0], this.vl[1])
        }
    },
    Bl: function(t, e, i, s) {
        var n = this.yl.style,
        ...
        if (this.Rl) {
            ...
            if ("x" == e) {
                ...
                var r = this.getIdByIndex(i.rind),
                    a = this.getItem(r).$height || this.s.rowHeight;
...
function() {
    ...
    dn: function(t, e) {
        ...
        if ("header" != e)
            for (var r = 0; r < this.data.order.length; r++) {
                var a = this.getItem(this.data.order[r]),
                    h = this.Ek(a, s, r);
    ...
    adjustRowHeight: function(t, e) {
        var i = this.getColumnConfig(t),
            s = (this.data.count(), webix.html.create("DIV", {
        ...
        s.style.cssText = "width:" + i.width + "px; height:1px; visibility:hidden; position:absolute; top:0px; left:0px; overflow:hidden;", this.$view.appendChild(s), this.data.each(function(t) {
            t && (s.innerHTML = this.Ek(t, i, 0), t.$height = Math.max(s.scrollHeight, this.s.rowHeight))
    ...
    hideColumn: function(t, e, i) {
        ...
        if (e !== !1) {
            ...
            a < this.s.leftSplit && this.s.leftSplit--, a >= this.Fj ? this.s.rightSplit-- : this.Fj--, this.xt(a, s[a], 0), this.vk(a);
            var o = r[t] = s.splice(a, 1)[0];
            o.qk = -1, delete this.Aj[t]
        } else {
            var o = r[t];
            if (!o) return;
            for (var l = null, h = 0; h < n.length && n[h] != t; h++) r[n[h]] || (l = n[h]);
            var a = l ? this.getColumnIndex(l) + 1 : 0;
            webix.PowerArray.insertAt.call(s, o, a), this.xt(a, o, 1), delete o.hidden, h < this.Mn[0] && this.s.leftSplit++, h >= this.Mn[1] ? this.s.rightSplit++ : this.Fj++, delete r[t], this.Aj[t] = o
        }
        i || this.On()
    },
    xt: function(t, e, i) {
        for (var s = e.header.length - 1; s >= 0; s--)
            if (null === e.header[s])
                ...
                } else e.header[s].colspan && 0 === i && (e.header[s].colspan = 1)
    },
    refreshColumns: function(t) {
        this.Aj = {};
        for (var e = 0; e < this.fj.length; e++) {
            var i = this.fj[e];
            this.Aj[i.id] = i, i.attached = i.node = null
        }
        for (var e = 0; 3 > e; e++) this.Vf.childNodes[e].firstChild.innerHTML = "";
        this.fj = this.config.columns = t || this.config.columns, this.tj = 0, this.callEvent("onStructureUpdate"), this.rj(), this.sk(), this.render()
    },
    On: function() {
    ...
    showColumnBatch: function(t) {
        this.eachColumn(function(e, i) {
            i.batch && (i.batch == t && this.am[i.id] ? this.hideColumn(i.id, !1, !0) : i.batch == t || this.am[i.id] || this.hideColumn(i.id, !0, !0))
        }, !0), this.On()
    }
}), webix.extend(webix.ui.datatable, {
        ...
        if (s >= 0) {
            ...
            if ("top" == t || "bottom" == t) {
                ...
                if (n) {
                    ...
                    "up" == t || "pgup" == t ? s -= h : ("down" == t || "pgdown" == t) && (s += h), 0 > s && (s = 0), s >= this.data.order.length && (s = this.data.order.length - 1), n = this.getIdByIndex(s)
                }
            } else {
    ...
    Wt: function(t, e, i) {
        for (var s = 0, n = this.data.order.length, r = 0; n > r; r++) {
            ...
            s += this.getItem(a).$height || this.s.rowHeight
        }
    },
    Vt: function() {
        for (var t = this.config.select, e = "cell" == t || "column" == t, i = this.getSelectedId(!0), s = this.Yt || [], n = webix.uid() + "", r = !1, a = 0; a < i.length; a++) {
            var h = this.Rt[i[a]];
            !h || e && !h[i[a].column] || (h.$selected || (r = !0), h.$selected = n)
        }
        for (var a = 0; a < s.length; a++) {
            var h = this.Rt[s[a]];
            h && h.$selected !== n && (h.$selected = "", r = !0)
        }
    ...
    $t: function(t, e) {
        for (var i = 0, s = t; e > s; s++) {
            ...
            i += (n ? n.$height : 0) || this.s.rowHeight
        }
        return i
    },
    Xt: function(t, e, i, s, n, r, a, h) {
        var o = s[h],
            ...
            c = s.$selected ? "webix_selected " : "",
            u = webix.html.create("DIV", {
                column: i,
                row: e,
    ...
    au: function() {
        ...
        if (!n.$blockRender && !this.Xw) {
            for (e = [], s = 0; s < this.fj.length; s++) t = this.fj[s], t.headermenu !== !1 && e.push({
                id: t.id,
                value: t.header[0].text
            });
            for (i = this.getState().hidden, s = i.length - 1; s >= 0; s--) t = this.getColumnConfig(i[s]), t.headermenu !== !1 && e.push({
                id: i[s],
                value: t.header[0].text,
                hidden: 1
            });
    ...
    refresh: function(t, e, i) {
        ...
        var r;
        r = i.options ? i.options : t.collectValues(i.columnId).slice(1);
        var a = s.getPopup().getList();
        a.parse && (a.clearAll(), a.parse(r)), i.value && this.setValue(e, i.value), e.firstChild.appendChild(s.$view.parentNode), s.render(), webix.delay(s.resize, s)
    },
    render: function(t, e) {
        if (!e.richselect) {
            var i = webix.html.create("div", {
            ...
            e.separator && (s.separator = e.separator);
            var n = webix.ui(s);
            n.attachEvent("onChange", function() {
                t.filterByAll()
            }), e.richselect = n.s.id, t.Ns.push(n)
        }
...
}, webix.ui.datafilter.richSelectFilter), webix.ui.datafilter.multiComboFilter = webix.extend({
    ...
    render: function() {
        ...
        if (this.isVisible(this.s.id) && this.callEvent("onBeforeRender", [this.data])) {
            ...
            else this.canvases = {}; if (this.s.legend && (this.canvases.legend || (this.canvases.legend = this.lo("legend")), this.mo(this.data.getRange(), this.bc, this.dc)), t = this.no(this.bc, this.dc), s = new webix.HtmlMap(this.ad), n = this.s, this.go)
    ...
    oo: function() {
        ...
        if (s = this.data.getRange(), t = -1 != this.s.type.toLowerCase().indexOf("barh") ? "yAxis" : "xAxis", e = this.s[t], e && e.units && "object" == typeof e.units) {
            ...
            else "[object Array]" === Object.prototype.toString.call(i) && (h = i); if (r = [], h.length) {
    ...
    line_setter: function(t) {
        return "object" != typeof t && (t = {
            color: t
        }), webix.extend(this.defaults.line, t, !0), t = webix.extend({}, this.defaults.line), t.color = webix.template(t.color), t
    },
    ...
    Zo: function(t, e, i, s, n, r, a, h) {
        ...
        if (o) {
            ...
            var p = (e + Math.floor((i + x) * Math.sin(u))) * r + f,
                v = t + Math.floor((i + c / 2) * Math.cos(u)) + d,
                w = n < Math.PI / 2 + .01,
                g = s < Math.PI / 2;
    ...
    $render_bar: function(t, e, i, s, n, r) {
        ...
        var _ = (h - a * m) / 2,
            ...
            k = !1,
            S = this.s.gradient;
        for (S && "function" != typeof S ? (k = S, S = !1) : S && (S = t.createLinearGradient(0, s.y, 0, i.y), this.s.gradient(S)), v || this.zo(t, i.x, s.y + .5, s.x, s.y + .5, "#000000", 1), o = 0; o < e.length; o++) {
            var I = parseFloat(this.s.value(e[o]) || 0);
            if (this.Bo && (I = this.Do(I)), !isNaN(I)) {
                I > c && (I = c), I -= u, I *= f;
                var C = i.x + _ + o * h + (a + 1) * y,
                    E = s.y;
                if (0 > I || this.s.yAxis && 0 === I && !("auto" != this.s.origin && this.s.origin > u)) this.canvases[n].renderTextAt(!0, !0, C + Math.floor(a / 2), E, this.s.label(e[o]));
                    ...
                    w || "auto" != this.s.origin && v || (I += x / p);
                    var M = S || this.s.color.call(this, e[o]);
                    t.globalAlpha = this.s.alpha.call(this, e[o]);
                    var j = this.bp(t, i, C, E, a, u, $, p, I, M, S, k);
                    k && this.cp(t, C, E, a, u, $, p, I, M, k), this.s.border && this.dp(t, C, E, a, u, $, p, I, M), t.globalAlpha = 1, j[0] != C ? this.canvases[n].renderTextAt(!1, !0, C + Math.floor(a / 2), j[1], this.s.label(e[o])) : this.canvases[n].renderTextAt(!0, !0, C + Math.floor(a / 2), j[3], this.s.label(e[o])), r.addRect(e[o].id, [C - i.x, j[3] - i.y, j[2] - i.x, j[1] - i.y], n)
                }
            }
        }
    },
                ...
                if (v = this.ip(e[h], i, s, l)) {
                    if (d = h ? l.cellWidth * h - .5 + c : c, b = "object" == typeof v ? v.y0 : v, h && this.s.fixOverflow) {
                        ...
                        u = l.cellWidth * (h - 1) - .5 + c, f = "object" == typeof p ? p.y0 : p, p.out && (x = "min" == p.out ? s.y : i.y, o.push({
                            x: this.jp(u, d, f, b, x),
                            y: x
                        })), v.out && (x = "min" == v.out ? s.y : i.y, o.push({
                            x: this.jp(u, d, f, b, x),
                            y: x
                        }))
                    }
    ...
    $render_barH: function(t, e, i, s, n, r) {
        var a, h, o, l, c, u, d, f, b, x, p, v, w, g, m, y, _, $, k, S, I;
        for (o = (s.y - i.y) / e.length, d = this.Go("h"), f = d.max, b = d.min, y = s.x - i.x, I = !! this.s.yAxis, n || this.mp(t, e, i, s, b, f, o), I && (f = parseFloat(this.s.xAxis.end), b = parseFloat(this.s.xAxis.start)), g = this.Ho(b, f), v = g[0], p = g[1], $ = v ? y / v : 10, I || (m = 10, $ = v ? (y - m) / v : 10), h = parseInt(this.s.barWidth, 10), h * this.go.length + 4 > o && (h = o / this.go.length - 4), a = Math.floor((o - h * this.go.length) / 2), w = "undefined" != typeof this.s.radius ? parseInt(this.s.radius, 10) : Math.round(h / 5), x = !1, c = this.s.gradient, c && "function" != typeof c ? (x = c, c = !1) : c && (c = t.createLinearGradient(i.x, i.y, s.x, i.y), this.s.gradient(c)), I || this.zo(t, i.x - .5, i.y, i.x - .5, s.y, "#000000", 1), u = 0; u < e.length; u++)
            if (_ = parseFloat(this.s.value(e[u] || 0)), this.Bo && (_ = this.Do(_)), _ > f && (_ = f), _ -= b, _ *= p, k = i.x, S = i.y + a + u * o + (h + 1) * n, 0 > _ && "auto" == this.s.origin || this.s.xAxis && 0 === _ && !("auto" != this.s.origin && this.s.origin > b)) this.canvases[n].renderTextAt("middle", "right", k + 10, S + h / 2 + a, this.s.label(e[u]));
            else {
                0 > _ && "auto" != this.s.origin && this.s.origin > b && (_ = 0), I || (_ += m / $), l = c || this.s.color.call(this, e[u]), this.s.border && this.np(t, k, S, h, b, w, $, _, l), t.globalAlpha = this.s.alpha.call(this, e[u]);
                var C = this.op(t, s, k, S, h, b, w, $, _, l, c, x);
                x && this.pp(t, k, S, h, b, w, $, _, l, x), t.globalAlpha = 1, C[3] == S ? (this.canvases[n].renderTextAt("middle", "left", C[0] - 5, C[3] + Math.floor(h / 2), this.s.label(e[u])), r.addRect(e[u].id, [C[0] - i.x, C[3] - i.y, C[2] - i.x, C[3] + h - i.y], n)) : (this.canvases[n].renderTextAt("middle", !1, C[2] + 5, C[1] + Math.floor(h / 2), this.s.label(e[u])), r.addRect(e[u].id, [C[0] - i.x, S - i.y, C[2] - i.x, C[3] - i.y], n))
            }
    },
    ...
    $render_stackedBar: function(t, e, i, s, n, r) {
        ...
        l = x[0], o = x[1];
        var p = l ? c / l : 10,
            v = parseInt(this.s.barWidth, 10);
        v + 4 > b && (v = b - 4);
        var w = Math.floor((b - v) / 2),
        ...
        for (var m = 0; m < e.length; m++) {
            ...
            if (this.Bo && (y = this.Do(y)), y) {
                ...
                var _ = i.x + w + m * b,
                    $ = s.y;
                if (n ? $ = e[m].$startY : e[m].$startY = $, !($ < i.y + 1))
                    if (0 > y || this.s.yAxis && 0 === y) this.canvases.y.renderTextAt(!0, !0, _ + Math.floor(v / 2), $, this.s.label(e[m]));
                    else {
                        ...
                        var S = this.up(t, _ - (this.s.border ? .5 : 0), $, v + (this.s.border ? .5 : 0), p, y, 0, i.y);
                        if (t.fill(), g) {
                            t.save();
                            var I = this.Oo(t, _, $, _ + v, S[1], g, k, "y");
                            t.fillStyle = I.gradient, t.beginPath(), S = this.up(t, _ + I.offset, $, v - 2 * I.offset, p, y, this.s.border ? 1 : 0, i.y), t.fill(), t.restore()
                        }
                        this.s.border && (t.save(), this.gp(t, k), t.beginPath(), this.up(t, _ - .5, $, v + 1, p, y, 0, i.y, 1), t.stroke(), t.restore()), t.globalAlpha = 1, this.canvases[n].renderTextAt(!1, !0, _ + Math.floor(v / 2), S[1] + ($ - S[1]) / 2 - 7, this.s.label(e[m])), r.addRect(e[m].id, [_ - i.x, S[1] - i.y, S[0] - i.x, (e[m].$startY || $) - i.y], n), e[m].$startY = this.s.border ? S[1] + 1 : S[1]
                    }
    ...
    $render_stackedBarH: function(t, e, i, s, n, r) {
        ...
        for (var k = 0; k < e.length; k++) {
            $ || (e[k].$startX = i.x);
            var S = parseFloat(this.s.value(e[k] || 0));
            S > a && (S = a), S -= h, S *= o;
            var I = i.x,
                C = i.y + w + k * f;
            if ($ ? I = e[k].$startX : e[k].$startX = I, 0 > S || this.s.yAxis && 0 === S) this.canvases.y.renderTextAt("middle", !0, I + 10, C + v / 2, this.s.label(e[k]));
            else {
                u || (S += p / x);
                ...
                var M = this.qp(t, I, C, v, g, x, S, this.s.border ? 1 : 0);
                if (y && !m && t.lineTo(i.x + c, C + (this.s.border ? 1 : 0)), t.fill(), m) {
                    var j = this.Oo(t, I, C + v, I, C, m, E, "x");
                    t.fillStyle = j.gradient, t.beginPath(), M = this.qp(t, I, C, v, g, x, S, 0), t.fill()
                }
                this.s.border && this.np(t, I, C, v, h, g, x, S, E), t.globalAlpha = 1, this.canvases[n].renderTextAt("middle", !0, e[k].$startX + (M[0] - e[k].$startX) / 2 - 1, C + (M[1] - C) / 2, this.s.label(e[k])), r.addRect(e[k].id, [e[k].$startX - i.x, C - i.y, M[0] - i.x, M[1] - i.y], n), e[k].$startX = M[0]
            }
        }
    }
}), webix.extend(webix.ui.chart, {
    ...
    $render_area: function(t, e, i, s, n, r) {
        ...
        if (u = this.hp(t, e, i, s, n), h = this.s, l = h.eventRadius || Math.floor(u.cellWidth / 2), e.length) {
            for (d = [], x = h.offset ? i.x + .5 * u.cellWidth : i.x, o = 0; o < e.length; o++)
                if (c = e[o], b = this.ip(c, i, s, u), w = x + u.cellWidth * o, b) {
    ...
    $render_stackedArea: function(t, e, i, s, n, r) {
        ...
        if (x = this.hp(t, e, i, s, n), l = this.s, f = l.eventRadius || Math.floor(x.cellWidth / 2), e.length) {
            ...
            if (p.push([v, m(c - 1, s.y)]), n)
                for (c = e.length - 2; c > 0; c--) v -= x.cellWidth, w = e[c].$startY, w && p.push([v, w]);
            for (p.push([p[0][0], p[0][1]]), t.globalAlpha = this.s.alpha.call(this, e[0]), t.fillStyle = this.s.color.call(this, e[0]), t.beginPath(), this.Mo(t, p), t.fill(), c = 0; c < e.length; c++) {
                if (w = g[c], !w)
                    for (c == e.length - 1 && (w = e[c].$startY), u = c + 1; u < e.length; u++)
                        if (g[u]) {
                            a = {
                                x: i.x,
                                y: g[0]
    ...
    yp: function(t, e, i, s, n) {
        ...
        for (f = o; f >= h; f -= l) {
            ...
            var S, I = -Math.PI / 2,
                C = I;
            for (b = 0; b < t.length; b++) f == o && y.push(C), S = I + t[b] - 1e-4, this.Dp(_, t.length > 2 ? u.lineShape || "line" : "arc", e, i, s - w[w.length - 1], C, S, f, b, n[f]), C = S;
            g++
        }
    ...
    Xp: function(t, e, i) {
        for (var s = this.s, n = "", r = webix.Date.datePart(webix.Date.copy(i.Rp)), a = s.weekNumber ? 1 : 0, h = webix.Date.getISOWeek(webix.Date.add(r, 2, "day", !0)), o = (this.s.minDate || new Date(1, 1, 1), this.s.maxDate || new Date(9999, 1, 1), 0); o < e.length; o++) {
            n += "<div class='webix_cal_row' style='height:" + e[o] + "px;line-height:" + e[o] + "px'>", a && (n += "<div class='webix_cal_week_num' style='width:" + t[0] + "px'>" + h + "</div>");
    ...
    cq: function(t) {
        ...
        if (t && (this.s.date = t), this.Up || (this.hq = this.w.offsetHeight - this.s.headerHeight - this.s.timepickerHeight, this.iq = l[h].offsetWidth, this.Up = 1), this.jq) {
            ...
            var c = 6,
                ...
                d = u.match(/%([a,A])/);
            for (d && c++, r = parseInt((this.iq - 3) / c, 10), a += "<div class='webix_time_header'>" + this.kq(r, d) + "</div>", a += "<div  class='webix_cal_body' style='height:" + this.hq + "px'>", a += "<div class='webix_hours'>", n = this.s.date.getHours(), s = 0; 24 > s; s++) {
                if (e = "", d && ((n > 11 && 11 >= s || 11 >= n && s > 11) && (e = " webix_cal_blurred_hours"), s % 4 === 0)) {
                    var f = 4 == s ? "AM" : 16 == s ? "PM" : "";
                    a += "<div class='webix_cal_block_empty" + e + "' style='" + this.lq(r, i) + "clear:both;'>" + f + "</div>"
                }
                e += n == s ? " webix_selected" : "";
            ...
            for (a += "</div>", a += "<div class='webix_minutes'>", n = this.s.date.getMinutes(), s = 0; 60 > s; s += this.s.minuteStep) e = n == s ? " webix_selected" : "", a += "<div class='webix_cal_block webix_cal_block_min" + e + "' data-value='" + s + "' style='" + this.lq(r, i) + (s % 2 === 0 ? "clear:both;" : "") + "'>" + webix.Date.toFixed(s) + "</div>";
    ...
    Kt: function(t) {
        ...
        var s = webix.ui(i),
            n = s.getList();
        return "string" == typeof t ? n.load(t) : e || n.parse(t), s.attachEvent("onBeforeShow", function() {
    ...
    setValue: function(t) {
        ...
        return this.s.value = t ? t.join(this.config.separator) : "", e.join(this.config.separator + " ")
    },
    getValue: function() {
        return this.s.value
    }
    ...
    setValue: function(t) {
        ...
        return this.s.value = t.length ? t.join(this.config.separator) : "", s.join(this.config.separator + " ")
    },
    getValue: function() {
        return this.s.value
    },
    ...
    $init: function() {
        this.$view.className += " webix_multicombo", this.attachEvent("onBlur", webix.bind(function() {
            this.xy = "", this.refresh()
        }, this)), this.attachEvent("onBeforeRender", function() {
            return this.zy || (this.zy = this.config.aheight), !0
    ...
    yy: function(t, e) {
        var i = t.id || webix.uid(),
            s = e.Ee(t),
            n = t.inputAlign || "left",
            r = this.zy - 2 * webix.skin.$active.inputPadding - 2,
            a = (t.text || t.value || this.Yx(t), t.value, "<ul class='webix_multicombo_listbox' style='line-height:" + r + "px'></ul>"),
            h = "<input type='text' class='webix_multicombo_input' style='width: " + Math.min(s, e.By || 7) + "px;height:" + r + "px;max-width:" + (s - 20) + "px' value='" + (e.xy || "") + "'/>",
            o = "<div class='webix_inp_static' tabindex='0' onclick='' style='line-height:" + r + "px;width: " + s + "px;  text-align: " + n + ";height:auto' >" + a + h + "</div>",
            l = e.$renderLabel(t, i);
        return top ? l + "<div class='webix_el_box' style='width:" + this.s.awidth + "px; '>" + o + "</div>" : "<div class='webix_el_box' style='width:" + this.s.awidth + "px; min-height:" + this.s.aheight + "px;'>" + l + o + "</div>"
    },
    Cy: function() {
    ...
    oe: function() {
        var t = this.getPopup();
        if (t) {
            var e = t ? t.setValue(this.s.value) : "",
                i = "",
                s = this.Cy();
            if (e)
                for (var n = this.s.value.split(this.s.separator), r = e.split(this.s.separator), a = this.zy - 2 * webix.skin.$active.inputPadding - 8, h = 0; h < r.length; h++) {
                    var o = "<span>" + r[h] + "</span><span class='webix_multicombo_delete'>x</span>";
                    i += "<li class='webix_multicombo_value' style='line-height:" + a + "px;' value='" + n[h] + "'>" + o + "</li>"
                }
            s.innerHTML = i
        }
        this.Dy()
    ...
    Dy: function() {
        var t = "top" == this.s.labelPosition,
            e = Math.max(this.re().firstChild.offsetHeight + 2 * webix.skin.$active.inputPadding, this.zy) + (t ? this.le : 0),
            i = this.$getSize(0, 0);
        if (e != i[2]) {
            this.Fy = this.re().firstChild.offsetHeight + (t ? this.le : 0);
            var s = this.getTopParentView();
            clearTimeout(s.kg), s.kg = webix.delay(function() {
                this.config.height = this.Fy + 2 * webix.skin.$active.inputPadding, this.resize(), this.Hy && (this.Ey(this.getInputNode()), this.Hy = !1), this.bz && (this.getInputNode().select(), this.bz = !1), (this.getPopup().isVisible() || this.Hy) && this.getPopup().show(this.re().firstChild)
            }, this)
        }
    ...
    De: function() {
        webix.event(this.re(), "click", function() {
            ...
            !this.getInputNode().value && this.xy && (this.getInputNode().style.width = "20px", this.By = 20, this.xy = "", this.Hy = !0, this.getPopup().show(this.re().firstChild), this.Dy())
        }, this), webix.event(this.getInputNode(), "keyup", function() {
            var t = this.getInputNode(),
                e = this.Iy(t.value) + 10;
            t.style.width = e + "px", e != this.By && (this.By = e, this.xy = t.value, this.Hy = !0, this.getPopup().show(this.re().firstChild), this.Dy())
        }, this), webix.event(this.getInputNode(), "keydown", function(t) {
            if (this.bz = !1, this.isVisible()) {
                t = t || event;
                var e = this.Cy().lastChild;
                if (8 == t.keyCode && e && (!this.getInputNode().value && (new Date).valueOf() - (this.Jy || 0) > 800 ? (this.Hy = !0, this.Ay(e.getAttribute("value"))) : this.Jy = (new Date).valueOf()), 13 == t.keyCode || 9 == t.keyCode) {
                    var i = this.getInputNode(),
                        s = "",
                        n = webix.$$(this.s.suggest),
                        r = n.getList();
                    r.getSelectedId() || (i.value && (s = n.getSuggestion()), s && (9 == t.keyCode ? (this.Hy = !1, this.xy = "", this.By = 10, i.value = "", this.az(s)) : (this.bz = !0, this.az(s)))), 13 == t.keyCode && (this.bz = !0, this.Hy = !0)
                }
            }
    ...
    kr: function(t) {
        ...
        return webix.callEvent("onClick", []), e === !1 ? !1 : webix.html.preventEvent(t)
    },
    gr: !0,
    ...
    Dr: function(t, e, i) {
        ...
        if (webix.isUndefined(e.$parent) || (n.data.parent = e.$parent), "delete" != n.operation) {
            var r = this.s.master;
            r && r.data && r.data.getMark && r.data.getMark(t, "webix_invalid") && (n.Er = !0), this.validate(n.data) || (n.Er = !0)
        }
        return this.Fr(n) && this.zr.push(n), this.s.autoupdate && this.send(), !0
    },
    Br: function(t, e, i) {
        if (this.s.trackMove) {
            var s = webix.copy(this.s.store.getItem(t)),
                n = this.s.store.order;
    ...
    Jr: function(t, e, i, s, n, r) {
        ...
        } else this.setItemState(e, !1); if (n && "delete" != s && this.s.updateFromResponse) {
    ...
    Or: function(t, e, i) {
        ...
        if (this.Xr(t, i, e), o.length) i.stack ? i[i.stack] = o : this.Mr(i.view, "setValues") ? i.elements = o : "rows" == i.view ? (i.view = "layout", i.rows = o) : "cols" == i.view ? (i.view = "layout", i.cols = o) : this.Mr(i.view, "setValue") ? i.cells = o : this.Mr(i.view, "getBody") ? i.body = 1 == o.length ? o[0] : {
            ...
            if (!e || i.template || i.view && "template" != i.view) {
                ...
                if (v) {
                    var w = "template";
                    this.Mr(i.view, "setValue") && (w = "value"), i[w] = i[w] || v
                }
    ...
    Xr: function(t, e, i) {
        for (var s = t.attributes, n = 0; n < s.length; n++) {
            ...
            var a = s[n].value; - 1 != a.indexOf("json://") && (a = JSON.parse(a.replace("json://", ""))), this.Lr[r] && (a = parseInt(a, 10)), e[r] = a
        }
        return e
    }
},
function() {
    ...
    Gt: function() {
        ...
        e[t] = webix.copy(this.config[t]), webix.extend(e, e.layoutConfig || {}, !0), this.Ft = webix.ui.A(e), this.Ft.Xb = this, this.x.appendChild(this.Ft.x), this.q = this.Ft.q, this.Ft.fc = webix.bind(webix.ui.carousel.prototype.fc, this), this.Ft.adjustScroll = webix.bind(webix.ui.carousel.prototype.adjustScroll, this), webix.attachEvent("onReconstruct", webix.bind(function(t) {
            t == this.Ft && this.Ht()
    ...
    flash: {
        $render: function() {
            window.swfobject || webix.require("legacy/swfobject.js");
            var t = this.s;
        ...
        $onUploadSuccess: function(t, e, i) {
            ...
            s && (s.status = "server", s.progress = 100, i.data && "string" == typeof i.data && (i = JSON.parse(i.data), webix.extend(s, i, !0)), this.callEvent("onFileUpload", [s, i]), this.callEvent("onChange", []), this.files.updateItem(t))
        },
    ...
    html5: {
        ...
        send: function(t, e) {
            ...
            r.status = "transfer";
            var a = new FormData;
            a.append("upload", r.file);
            var h = {};
            if (e = e || {}, webix.callEvent("onBeforeAjax", ["POST", this.s.upload, e, l, h, a])) {
                for (var o in e) a.append(o, e[o]);
                var l = r.xhr = new XMLHttpRequest;
                l.upload.addEventListener("progress", webix.bind(function(e) {
                    this.$updateProgress(t, e.loaded / e.total * 100)
                }, this), !1), l.onload = webix.bind(function() {
                    l.aborted || this.is(t)
                }, this), l.open("POST", this.s.upload, !0);
                for (var o in h) l.setRequestHeader(o, h[o]);
                l.send(a)
            }
        ...
        is: function(t) {
            ...
            if (e) {
                var i = null;
                200 == e.xhr.status && (i = webix.DataDriver.json.toObject(e.xhr.responseText)), i && "error" != i.status ? this.js(t, i) : (e.status = "error", delete e.percent, this.files.updateItem(t), this.callEvent("onFileUploadError", [e, i])), delete e.xhr
            }
        },
        stopUpload: function(t) {
...
function() {
    ...
    angular.module("webix", []).directive("webixUi", ["$parse",
        function(e) {
            return {
                restrict: "A",
                scope: !1,
                            ...
                            if (a && (a = e(a)), s.bind("$destroy", function() {
                                ...
                                var t = function() {
                                    if (h && h.destructor(), i[r]) {
                                        ...
                                        t.$scope = i, h = webix.ui(t, s[0]), a && a(i, {
                                            root: h
                                        })
                                    }
                                };
    ...
    webix.attachEvent("onUnSyncUnknown", function(t, e) {
        ...
        render: function() {
            ...
            var t = this.config || this.options.config,
                e = this.el ? $(this.el)[0] : document.body;
    ...
    showProgress: function(t) {
        if (!this.cu) {
            ...
            }, "<div class='webix_progress_state " + e + "'></div>"), this.x.style.position = "relative", webix.html.insertBefore(this.cu, this.x.firstChild, this.x), !webix.Touch.$active && this.getScrollState) {
                var i = this.getScrollState();
            ...
            if (this.cu) {
                ...
                if (this.cu.style[webix.env.transitionDuration] === webix.undefined && t.delay) {
                    ...
                    this.Oy && (window.clearInterval(this.Oy), s = this.cu.firstChild.offsetWidth / this.cu.offsetWidth * 100), this.Oy = window.setInterval(function() {
                        30 * i == t.delay ? window.clearInterval(r.Oy) : (r.cu.firstChild.style.width = s + i * n * e * 100 + "%", i++)
                    }, 30)
    ...
    _x: function(t) {
        ...
        if (t || (this.ay = [], this.$xy = {}, n = this.$width - 2 * this.type.padding, this.$xy[0] = {
            ...
            s = this.$xy[t], "list" == l && (r += this.type.templateListStart.call(this, o, this.type, h));
            var c = 0;
            for (e = 0; e < a.length; e++) {
                ...
                this.$xy[i] = "list" == l ? {
                    ...
                    height: d,
                    left: s.start + n / 2 - this.type.width / 2,
                    top: e ? this.$xy[a[e - 1]].top + this.$xy[a[e - 1]].height : s.top + s.height + this.type.marginY
                } : {
                    totalWidth: n,
                    start: s.start + c,
                    width: this.type.width,
            ...
            for (!t && c && (this.y.style.width = c + 2 * this.type.padding + "px"), e = 0; e < a.length; e++) i = a[e], this.data.branch[i] ? r += this._x(i) : "list" != o.$type ? this.ay.push(this.$xy[i].top + this.$xy[i].height) : e == a.length - 1 && this.ay.push(this.$xy[i].top + this.$xy[i].height);
            "list" == l && (r += this.type.templateListEnd(o, this.type, h))
        }
        return r
    },
    cy: function(t) {
    ...
    getItemNode: function(t) {
        ...
        for (var e = this.y.childNodes, i = 0; i < e.length; i++) {
            var s = e[i].getAttribute(this.ad);
            if (s && (this.t[s] = e[i]), -1 != e[i].className.indexOf("webix_organogram_list"))
    ...
    gy: function(t, e) {
        ...
        if (e || (e = this.canvas.getCanvas()), this.$xy && (t = t || 0, n = this.data.branch[t], s = this.getItem(t), n && n.length)) {
            if (r = this.$xy[t], t) {
                if (h = parseInt(r.left + r.width / 2, 10) + .5, o = parseInt(r.top + r.height, 10), l = parseInt(r.top + r.height + this.type.marginY / 2, 10), "list" == s.$type) return l = parseInt(r.top + r.height + this.type.marginY, 10), void this.zo(e, h, o, h, l, this.type.lineColor);
                this.zo(e, h, o, h, l, this.type.lineColor)
            }
            for (o = parseInt(r.top + r.height + this.type.marginY / 2, 10) + .5, i = 0; i < n.length; i++) {
                if (t) {
                    a = this.$xy[n[i]];
                    var h = parseInt(a.left + a.width / 2, 10) + .5;
                    i ? i == n.length - 1 && (u = h) : c = h, l = parseInt(a.top, 10), this.zo(e, h, o, h, l, this.type.lineColor)
                }
                this.gy(n[i], e)
            }
    ...
    type: {
        ...
        templateStart: function(t, e, i) {
            var s = "";
            if ((!i || !i.list_item) && this.$xy) {
                var n = this.$xy[t.id];
                s += "width: " + n.width + "px; height: " + n.height + "px;", s += "top: " + n.top + "px; left: " + n.left + "px;"
            }
            return '<div webix_dg_id="' + t.id + '" class="' + e.classname(t, e, i) + '"' + (s ? 'style="' + s + '"' : "") + '">'
        },
        templateEnd: webix.template("</div>"),
        templateListStart: function(t, e, i) {
            ...
            return '<div class="' + e.listClassName(t, e, i) + '"' + (s ? 'style="' + s + '"' : "") + '">'
        },
...
function() {
    var t = webix.CustomScroll = {
        ...
        init: function() {
            ...
            }), webix.attachEvent("onReconstruct", t.hu)
        },
        mk: function(e) {
        ...
        enable: function(e, i) {
            if (t.ze(), e.columns_setter) return this.mk(e);
            var s = e;
        ...
        ku: function() {
            if (t.gu = this, clearTimeout(this.tu), !this.ou && !t.qu) {
                ...
                this.ou = e, e.ec && (e.uu = t.Om(this, "x", e.dx, e.px, "width", "height"), e.vu = e.px - e.uu.offsetWidth - 4, e.wu = e.dx - e.px), e.cc && (e.xu = t.Om(this, "y", e.dy, e.py, "height", "width"), e.yu = e.py - e.xu.offsetHeight - 4, e.zu = e.dy - e.py), t.sk(this)
            }
        },
        ru: function(e, i, s) {
            var n = e.ou,
        ...
        pu: function() {
            if (this.ou) {
                ...
                var e = this.ou;
                t.Cu(e.uu), t.Cu(e.xu), webix.html.removeCss(document.body, "webix_noselect"), this.ou = null
            }
        },
        nu: function(e) {
            var i = this.ou,
        ...
        sk: function(t, e, i) {
            ...
            if (s && (s.uu || s.xu)) {
                var n = t.iu,
                    ...
                    l = n ? webix.$$(n).jk : o,
                    c = n ? 0 : l;
                s.uu && (s.uu.style.bottom = 1 - c + "px", s.uu.style.left = Math.round(s.vu * a / (s.dx - s.px)) + h + 1 + "px"), s.xu && (s.xu.style.right = 1 - h + "px", s.xu.style.top = Math.round(s.yu * l / (s.dy - s.py)) + c + 1 + "px")
            }
        }
    }
}(), webix.protoUI({
